      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1 flex flex-col gap-5">
            <Link href="/" className="flex items-center gap-2 w-fit group" aria-label="UniTurkey home">
              <div className="w-9 h-9 rounded-lg bg-primary flex items-center justify-center shadow-[0_0_15px_-3px_hsl(var(--primary))]">
            ...
            <div className="flex items-center gap-3 mt-1">
              <a
                ...
                aria-label="UniTurkey on X / Twitter"
                className="w-11 h-11 rounded-md border border-border bg-secondary flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/40 transition-colors"
              >
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622Zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a
                href="https://instagram.com"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="UniTurkey on Instagram"
                className="w-11 h-11 rounded-md border border-border bg-secondary flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/40 transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="UniTurkey on LinkedIn"
                className="w-11 h-11 rounded-md border border-border bg-secondary flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/40 transition-colors"
              >
          ...
          <nav aria-label="Quick links">
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: '/explore', label: t('footer.linkExplore') },
                { href: '/services', label: t('footer.linkServices') },
                { href: '/login', label: t('footer.linkLogin') },
              ].map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
          ...
          <address className="not-italic">
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <Mail className="w-4 h-4 shrink-0 group-hover:text-primary transition-colors" aria-hidden="true" />
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-sm text-muted-foreground hover:text-primary transition-colors group"
                >
                  <Phone className="w-4 h-4 shrink-0 group-hover:text-primary transition-colors" aria-hidden="true" />
