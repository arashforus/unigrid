          ...
          <div className="md:col-span-1 flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3 mt-1">
              <a
                ...
                className="w-8 h-8 rounded-md border border-border bg-secondary flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/40 transition-colors"
              >
