...
import {
  ...
  ClipboardList, Settings as SettingsIcon, MapPin, LogOut, ShieldAlert, Loader2, Bot, DollarSign, Link2, Sparkles, Newspaper,
} from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/admin/university-urls', label: 'University URLs', icon: Link2 },
  { href: '/admin/ai-requests', label: 'AI Requests', icon: Sparkles },
